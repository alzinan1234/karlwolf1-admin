              ...
              >
                ...
                <div className="self-stretch flex justify-between items-center mt-2">
                  ...
                  >
                    ...
                    />
                    <div className="w-[18px] h-[18px] bg-white peer-checked:bg-[#BB2821] rounded-[2px] border border-[#DCDCDC] peer-checked:border-[#BB2821] flex items-center justify-center relative">
                      {/* Custom checkmark */}
                      {rememberMe && (
                        <svg
